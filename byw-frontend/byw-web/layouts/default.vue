<template>
  <div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
      <!-- 顶部条 - 用户信息 -->
      <div class="bg-gray-100 text-xs text-gray-500">
      ...
      <div class="max-w-7xl mx-auto px-4 py-4 flex items-center gap-8">
        ...
        <NuxtLink to="/" class="flex-shrink-0">
          ...
          <p class="text-xs text-gray-400 text-center">买你所想</p>
        </NuxtLink>
        ...
        <NuxtLink
          to="/cart"
          class="relative flex items-center gap-2 px-4 py-2 border border-primary text-primary rounded-full hover:bg-primary hover:text-white transition-colors"
        >
      ...
      <nav class="border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4">
          <ul class="flex items-center gap-6 h-10 text-sm">
            <li><NuxtLink to="/" class="text-primary font-medium hover:text-primary-700">首页</NuxtLink></li>
