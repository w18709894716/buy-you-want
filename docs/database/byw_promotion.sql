...
CREATE TABLE t_coupon (
    ...
    new_user TINYINT DEFAULT 0 COMMENT '是否新人专享：0普通 1新人专享',
    shop_id BIGINT DEFAULT NULL COMMENT '归属店铺ID：NULL平台券(全场通用) 其他为店铺券',
...
-- 优惠券
INSERT INTO t_coupon (name, type, discount_value, min_amount, total_count, claimed_count, start_time, end_time, status, new_user) VALUES
('新人专享券', 3, 50.00, 0.00, 1000, 256, '2026-06-01 00:00:00', '2026-12-31 23:59:59', 1, 1),
('满100减20', 1, 20.00, 100.00, 5000, 1280, '2026-06-01 00:00:00', '2026-06-30 23:59:59', 1, 0),
('满500减100', 1, 100.00, 500.00, 2000, 456, '2026-06-01 00:00:00', '2026-06-30 23:59:59', 1, 0),
('满1000减200', 1, 200.00, 1000.00, 1000, 189, '2026-06-01 00:00:00', '2026-06-30 23:59:59', 1, 0),
('618大促8折券', 2, 0.80, 200.00, 3000, 890, '2026-06-15 00:00:00', '2026-06-20 23:59:59', 1, 0),
('数码品类专享', 1, 300.00, 2000.00, 500, 78, '2026-06-01 00:00:00', '2026-07-31 23:59:59', 1, 0),
('服装品类5折券', 2, 0.50, 100.00, 1000, 345, '2026-06-01 00:00:00', '2026-06-30 23:59:59', 1, 0),
('无门槛10元券', 3, 10.00, 0.00, 10000, 3456, '2026-01-01 00:00:00', '2026-12-31 23:59:59', 1, 0);
